...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function ensureMobileHeaderButtons() {
    ...
    if (!(links instanceof HTMLElement)) {
      ...
      links.innerHTML = [
        '<a class="site-mobile-header-link" href="index.html">Home</a>',
        '<a class="site-mobile-header-link" href="about.html">About</a>',
        '<a class="site-mobile-header-link" href="products.html">Products</a>',
        '<a class="site-mobile-header-link" href="industries.html">Industries</a>',
        '<a class="site-mobile-header-link" href="machines.html">Machines</a>',
        '<a class="site-mobile-header-link" href="contact.html">Contact</a>'
      ].join('');
